...
export const mockPosts: Post[] = [
  {
    id: '1',
    caption: 'Just Finished overseeing a major renovation project in downtown Abu Dhabi. The transformation is incredible',
    image: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&h=400&fit=crop',
    timestamp: 'Today, 2:13PM',
    likes: 26,
    comments: 12,
    shares: 568,
    hashtags: ['#RealEstate', '#Construction'],
  },
  {
    id: '2',
    caption: 'Just Finished overseeing a major renovation project in downtown Abu Dhabi. The transformation is incredible',
